...
import { DatabaseConnection } from '../interfaces/DatabaseConnection';
   ...
   */
function updateRecordsRaw(connection, table_name, properties, where) {
    return __awaiter(this, void 0, void 0, function () {
        var funcName, error, update_sql, params, properties_sql, where_sql;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    funcName = 'updateRecordsRaw';
                    ...
                    return [4 /*yield*/, query_1.query(connection, update_sql + " SET " + properties_sql + " WHERE " + where_sql, params)];
