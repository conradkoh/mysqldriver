...
describe('All Tests', function () {
    ...
    it('Insert records', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, createUser(TEST_DATA.USER_3)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Get Records (with Emoji', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, record;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = Object.values(users)[2];
                    return [4 /*yield*/, db.getRecord('user', {
                            user_id: user.user_id,
                            index_number: user.index_number,
                        })];
                case 1:
    ...
    it('Get Records Order', function () { return __awaiter(void 0, void 0, void 0, function () {
        var usersList, user, records;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    usersList = Object.values(users);
                    user = usersList[usersList.length - 1];
    ...
    it('Get Records Order Wildcard (before)', function () { return __awaiter(void 0, void 0, void 0, function () {
        var usersList, user, user_id_partial, records;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    usersList = Object.values(users);
